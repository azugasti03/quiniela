...
export default function ParticipanteModal({ p, equiposStats, onClose }: Props) {
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-gray-100 to-gray-200 pt-10 pb-6 flex flex-col items-center">
          ...
          <Avatar nombre={p.nombre} foto={p.foto} fotoPosition={p.fotoPosition} size="lg" className="ring-4 ring-white shadow-lg" />
